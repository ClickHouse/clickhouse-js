...
export interface MergeTreeSettings {
  /** When granule is written  */
  min_compress_block_size?: UInt64
  /** Compress the pending uncompressed data in buffer if its size is larger or equal than the specified threshold. Block of data will be compressed even if the current granule is not finished. If this setting is not set  */
  max_compress_block_size?: UInt64
  ...
  /** Minimal ratio of number of default values to number of all values in column to store it in sparse serializations. If >= 1  */
  ...
  /** When there is more than specified number of merges with TTL entries in pool  */
  ...
  /** For background operations like merges  */
  ...
  /** Do fsync for every inserted part. Significantly decreases performance of inserts  */
  fsync_after_insert?: Bool
  /** Do fsync for part directory after all part operations (writes  */
  ...
  /** Sleep time for merge selecting when no part selected  */
  ...
  /** If table contains at least that many active parts in single partition  */
  parts_to_delay_insert?: UInt64
  /** If table contains at least that many inactive parts in single partition  */
  inactive_parts_to_delay_insert?: UInt64
  /** If more than this number active parts in single partition  */
  parts_to_throw_insert?: UInt64
  /** If more than this number inactive parts in single partition  */
  inactive_parts_to_throw_insert?: UInt64
  /** Max delay of inserting data into MergeTree table in seconds  */
  max_delay_to_insert?: UInt64
  /** If more than this number active parts in all partitions in total  */
  ...
  /** How many records may be in log  */
  max_replicated_logs_to_keep?: UInt64
  /** Keep about this number of last records in ZooKeeper log  */
  min_replicated_logs_to_keep?: UInt64
  /** If time passed after replication log entry creation exceeds this threshold and sum size of parts is greater than "prefer_fetch_merged_part_size_threshold  */
  prefer_fetch_merged_part_time_threshold?: Seconds
  /** If sum size of parts exceeds this threshold and time passed after replication log entry creation is greater than "prefer_fetch_merged_part_time_threshold  */
  ...
  /** ZooKeeper session expiration check period */
  zookeeper_session_expiration_check_period?: Seconds
  /** Retry period for table initialization */
  ...
  /** Do not remove non byte-identical parts for ReplicatedMergeTree */
  ...
  /** Period to clean old queue logs */
  ...
  /** Minimal delay from other replicas to close */
  min_relative_delay_to_close?: UInt64
  /** Minimal absolute delay to close */
  ...
  /** How many records about mutations that are done to keep. If zero  */
  ...
  /** The number of threads for concurrent removal of inactive data parts. One is usually enough  */
  ...
  /** Minimal amount of bytes to enable part re-balance over a JBOD array (0 - disabled).  */
