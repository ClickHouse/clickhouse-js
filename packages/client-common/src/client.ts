  ...
  async query<Format extends DataFormat = "JSON">(
    ...
    return this.tracer.startActiveSpan(
      ...
      async (span) => {
        ...
        // From here on, the span is owned by the ResultSet: it stays open
        // until the response stream is fully consumed, closed, or fails,
        // and the final response metrics are recorded right before it ends
