/**
 * This is a copy of ../../packages/client-common/src/client.ts that works with Vitest in Node.js.
 *
 * Merge the two when all the tests are migrated to Vitest or when
 * the web, common, and Node.js tests stop sharing the same test setup.
 */
