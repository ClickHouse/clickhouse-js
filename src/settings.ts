export type ClickHouseSettings = {
  ...
  // Maximum block size for reading (default: DEFAULT_BLOCK_SIZE)
  max_block_size?: UInt64
  // The maximum block size for insertion (default: DEFAULT_INSERT_BLOCK_SIZE)
  max_insert_block_size?: UInt64
  // Squash blocks passed to INSERT query to specified size in rows (default: DEFAULT_INSERT_BLOCK_SIZE)
  min_insert_block_size_rows?: UInt64
  // Squash blocks passed to INSERT query to specified size in bytes (default: (DEFAULT_INSERT_BLOCK_SIZE * 256))
  ...
  // Maximum block size for JOIN result (if join algorithm supports it). 0 means unlimited. (default: DEFAULT_BLOCK_SIZE)
  ...
  // The maximum size of the buffer to read from the filesystem. (default: DBMS_DEFAULT_BUFFER_SIZE)
  ...
  // Which part of the query can be read into RAM for parsing (the remaining data for INSERT (default: DBMS_DEFAULT_MAX_QUERY_SIZE)
  ...
  // Connection timeout if there are no replicas. (default: DBMS_DEFAULT_CONNECT_TIMEOUT_SEC)
  ...
  // " (default: DBMS_DEFAULT_RECEIVE_TIMEOUT_SEC)
  receive_timeout?: Seconds
  // " (default: DBMS_DEFAULT_SEND_TIMEOUT_SEC)
  send_timeout?: Seconds
  // Timeout for draining remote connections (default: 3)
  drain_timeout?: Seconds
  // The time in seconds the connection needs to remain idle before TCP starts sending keepalive probes (default: 290 /* less than DBMS_DEFAULT_RECEIVE_TIMEOUT_SEC */)
  ...
  // Block at the query wait loop on the server for the specified number of seconds. (default: DBMS_DEFAULT_POLL_INTERVAL)
  ...
  // The maximum number of attempts to connect to replicas. (default: DBMS_CONNECTION_POOL_WITH_FAILOVER_DEFAULT_MAX_TRIES)
  ...
  // Which replicas (among healthy replicas) to preferably send a query to (on the first attempt) for distributed processing. (default: LoadBalancing::RANDOM)
  ...
  // How to calculate TOTALS when HAVING is present (default: TotalsMode::AFTER_HAVING_EXCLUSIVE)
  ...
  // Minimal type in query_log to log (default: QueryLogElementType::QUERY_START)
  ...
  // How are distributed subqueries performed inside IN or JOIN sections? (default: DistributedProductMode::DENY)
  ...
  join_use_nulls?: Bool
  // Set default strictness in JOIN query. Possible values: empty string (default: JoinStrictness::All)
  ...
  // HTTP connection timeout. (default: DEFAULT_HTTP_READ_BUFFER_CONNECTION_TIMEOUT)
  http_connection_timeout?: Seconds
  // HTTP send timeout (default: DEFAULT_HTTP_READ_BUFFER_TIMEOUT)
  http_send_timeout?: Seconds
  // HTTP receive timeout (default: DEFAULT_HTTP_READ_BUFFER_TIMEOUT)
  ...
  // What to do when the limit is exceeded. (default: OverflowMode::THROW)
  ...
  // What to do when the leaf limit is exceeded. (default: OverflowMode::THROW)
  ...
  // When disabled (default) ANY JOIN will take the first found row for a key. When enabled (default: false)
  join_any_take_last_row?: Bool
  // Specify join algorithm. (default: JoinAlgorithm::DEFAULT)
  ...
  log_comment?: string
  // Send server text logs with specified minimum level to client. Valid values: 'trace' (default: LogsLevel::fatal)
  ...
  // Time period reduces replica error counter by 2 times. (default: DBMS_CONNECTION_POOL_WITH_FAILOVER_DEFAULT_DECREASE_ERROR_PERIOD)
  distributed_replica_error_half_life?: Seconds
  // Max number of errors per replica (default: DBMS_CONNECTION_POOL_WITH_FAILOVER_MAX_ERROR_COUNT)
  ...
  // Default table engine used when ENGINE is not set in CREATE statement. (default: DefaultTableEngine::None)
  ...
  // Maximum parser depth (recursion depth of recursive descend parser). (default: DBMS_DEFAULT_MAX_PARSER_DEPTH)
  max_parser_depth?: UInt64
  // Allow SETTINGS after FORMAT (default: false)
  allow_settings_after_format_in_insert?: Bool
  // Timeout after which temporary live view is deleted. (default: DEFAULT_TEMPORARY_LIVE_VIEW_TIMEOUT_SEC)
  temporary_live_view_timeout?: Seconds
  // Interval after which periodically refreshed live view is forced to refresh. (default: DEFAULT_PERIODIC_LIVE_VIEW_REFRESH_SEC)
  ...
  // How long locking request should wait before failing (default: DBMS_DEFAULT_LOCK_ACQUIRE_TIMEOUT_SEC)
  ...
  // Which MySQL types should be converted to corresponding ClickHouse types (rather than being represented as String). Can be empty or any combination of 'decimal' (default: 0)
  ...
  // Format of distributed DDL query result (default: DistributedDDLOutputMode::THROW)
  ...
  // Read/write timeout in seconds. Now supported only for MySQL (default: DBMS_DEFAULT_RECEIVE_TIMEOUT_SEC)
  external_storage_rw_timeout_sec?: UInt64
  // Set default Union Mode in SelectWithUnion query. Possible values: empty string (default: UnionMode::Unspecified)
  ...
  // Setting for short-circuit function evaluation configuration. Possible values: 'enable' - use short-circuit function evaluation for functions that are suitable for it (default: ShortCircuitFunctionEvaluation::ENABLE)
  ...
  // Min bytes required for remote read (url (default: 4 * DBMS_DEFAULT_BUFFER_SIZE)
  ...
  // Timeout for waiting for processing asynchronous insertion (default: DBMS_DEFAULT_LOCK_ACQUIRE_TIMEOUT_SEC)
  ...
  // Wait for committed changes to become actually visible in the latest snapshot (default: TransactionsWaitCSNMode::WAIT_UNKNOWN)
  ...
  // The way how to output UUID in MsgPack format. (default: FormatSettings::MsgPackUUIDRepresentation::EXT)
  ...
  // Method to read DateTime from text input formats. Possible values: 'basic' (default: FormatSettings::DateTimeInputFormat::Basic)
  date_time_input_format?: DateTimeInputFormat
  // Method to write DateTime to text output. Possible values: 'simple' (default: FormatSettings::DateTimeOutputFormat::Simple)
  ...
  // Compression codec used for output. Possible values: 'null' (default: "")
  ...
  // How to map ClickHouse Enum and CapnProto Enum (default: FormatSettings::EnumComparingMode::BY_VALUES)
  ...
  // The maximum number  of rows in one INSERT statement. (default: DEFAULT_BLOCK_SIZE)
