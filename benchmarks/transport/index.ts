 ...
 * replacing the legacy `http`/`https` modules with `fetch`/`undici`. Before
...
async function run(): Promise<void> {
  ...
  console.log('Transport benchmark: @clickhouse/client (http/https) vs fetch')
